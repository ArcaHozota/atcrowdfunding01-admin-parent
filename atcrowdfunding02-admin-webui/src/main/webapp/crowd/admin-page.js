...
function fillTableBody(pageInfo) {
    ...
    if (pageInfo == null || pageInfo.list == null || pageInfo.list.length === 0) {
        $("#adminPageBody").append("<tr><td colspan='4' align='center'>抱歉，沒有檢索到您所需的數據！</td></tr>");
        return null;
    }
    ...
    for (let i = 0; i < pageInfo.list.length; i++) {
        ...
        let checkBtn = "<button id='" + adminId + "' type='button' class='btn btn-success btn-xs checkBtn'><i class='glyphicon glyphicon-check'></i></button>";
