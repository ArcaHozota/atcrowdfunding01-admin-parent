				...
				<form class="form-group" role="form">
					...
					<div class="form-group has-success has-feedback">
						<input type="text" name="userPassword" class="form-control"
							id="inputSuccess3" placeholder="パスワード" autofocus>
					</div>
					<div class="form-group has-success has-feedback">
						<input type="text" name="email" class="form-control"
							id="inputSuccess4" placeholder="メールアドレス" autofocus>
						<p class="help-block label label-warning">格式xxx@xxxx.comに合わせるメールアドレスを入力してください。</p>
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<button id="saveAdminBtn" type="button" class="btn btn-success">保存</button>
			</div>
		</div>
	</div>
</div>