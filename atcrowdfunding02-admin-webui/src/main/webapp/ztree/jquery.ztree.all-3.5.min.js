...
(function (p) {
    var G, H, I, J, K, L, r = {}, u = {}, v = {}, M = {
        ...
        var a = b.target, c = h.getSetting(b.data.treeId), d = "", f = null, g = "", l = "", i = null, o = null,
            k = null;
    ...
    H = function (b, a) {
        var c = h.getSetting(b.data.treeId),
            d = c.view.autoCancelSelected && (b.ctrlKey || b.metaKey) && h.isSelectedNode(c, a) ? 0 : c.view.autoCancelSelected && (b.ctrlKey ||
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d) {
            if (!b.data.keep.leaf ||
                !a || a.isParent) if (j.isArray(c) || (c = [c]), b.data.simpleData.enable && (c = h.transformTozTreeFormat(b, c)), a) {
            ...
            b.push("<span id='",
                c.tId, e.id.ICON, "' title='' treeNode", e.id.ICON, " class='", i.makeNodeIcoClass(a, c), "' style='", i.makeNodeIcoStyle(a, c), "'></span><span id='", c.tId, e.id.SPAN, "'>", d, "</span>")
...
/*
 * JQuery zTree excheck v3.5.18 http://zTree.me/
 *
 * Copyright (c) 2010 Hunter.z
 *
 * Licensed same as jquery - MIT License
 * http://www.opensource.org/licenses/mit-license.php
 *
 * email: hunter.z@263.net Date: 2015-05-25
 */
(function (m) {
    var p, q, r, o = {
...
/*
 * JQuery zTree exedit v3.5.18 http://zTree.me/
 *
 * Copyright (c) 2010 Hunter.z
 *
 * Licensed same as jquery - MIT License
...
(function (w) {
    var I = {
        ...
        onHoverOverNode: function (b, a) {
            ...
            function c(b) {
                ...
                if (C.dragFlag == 1) {
                    ...
                    var j = p < e.edit.drag.borderMax &&
                        p > e.edit.drag.borderMin, K = q < e.edit.drag.borderMax && q > e.edit.drag.borderMin,
            ...
            var F = w(e.treeObj.get(0).ownerDocument), M = w(e.treeObj.get(0).ownerDocument.body), D, B, s, J = !1,
                h = e, x = e, H, R, T = null, U = null, u = null, v = d.move.TYPE_INNER, N = b.clientX, O = b.clientY,
                L = (new Date).getTime();
