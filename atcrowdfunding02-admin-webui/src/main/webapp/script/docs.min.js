...
!function (a, b, c) {
    ...
    var g = a.document, h = g.documentElement, i = "load", j = !1, k = "on" + i, l = "complete", m = "readyState",
        n = "attachEvent", o = "detachEvent", p = "addEventListener", q = "DOMContentLoaded", r = "onreadystatechange",
        s = "removeEventListener", t = p in g, u = j, v = j, w = [];
    ...
    function b(a, b) {
        var c = "border" == b ? "Width" : "", d = b + "Top" + c, e = b + "Right" + c, f = b + "Bottom" + c,
            g = b + "Left" + c;
    ...
    var a = function () {
        ...
        var e = a.prototype = "function" == typeof c ? c.prototype : c, f = new a,
    ...
    function g(a) {
        ...
        var c = new E({width: a.width, height: a.height}), d = c.Shape,
        ...
        addTheme: function (a, b) {
            ...
            for (m = 0; m < i.length; m++) {
                var s = b.getComputedStyle(i[m], null).getPropertyValue("background-image"),
                    v = i[m].getAttribute("data-background-src"), w = null;
                w = null == v ? s : v;
            ...
            for (m = 0; m < h.length; m++) {
                ...
                var K = null != J.src, L = null != J.dataSrc && 0 === J.dataSrc.indexOf(g.domain),
    ...
    var A = {
        ...
        return function (d) {
            ...
            if (A.setup.supportsSVG) {
                ...
                var j = b.getBBox(), k = Math.ceil(j.width / (e.properties.width * A.setup.lineWrapRatio)),
                    o = i.text.split(" "), p = i.text.match(/\\n/g);
                k += null == p ? 0 : p.length, c.nodeValue = i.text.replace(/[ ]+/g, "");
                var r = b.getComputedTextLength(), s = j.width - r, t = Math.round(s / Math.max(1, o.length - 1)),
                    u = [];
                if (k > 1) {
                    c.nodeValue = "";
        ...
        return function (c) {
            ...
            for (var f in e.children) {
                ...
                for (var h in g.children) {
                    var i = g.children[h], j = A.dpr(e.x + g.x + i.x),
            ...
            return a.appendChild(c), function (b, d) {
                ...
                for (var k in h.children) {
                    ...
                    for (var r in p.children) {
                        var s = p.children[r], t = h.x + p.x + s.x, u = h.y + p.y + s.y + h.properties.leading / 2,
                            v = l("text", x), w = y.createTextNode(null);
                        m(v, {
                            x: t,
                            y: u,
                            style: q({
...
*/
    !function (a) {
        ...
        var d, e = {bridge: null, version: "0.0.0", disabled: null, outdated: null, ready: null}, f = {}, g = 0, h = {},
            i = 0, j = {}, k = null, l = null, m = function () {
        ...
        var O = function () {
            ...
            if (!d) {
                ...
                var g = F(a.location.host, N), h = x(f), i = N.moviePath + w(N.moviePath, N),
